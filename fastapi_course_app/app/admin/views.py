...
class BookingsAdmin(ModelView, model=Bookings):
    ...
    column_sortable_list = [Bookings.date_from, Bookings.date_to, Bookings.price, Bookings.total_days, Bookings.total_cost]
...
class RoomsAdmin(ModelView, model=Rooms):
    ...
    column_list = [
        Rooms.id, Rooms.name, 'hotel', Rooms.price, Rooms.quantity, 'booking'
    ]
    column_details_exclude_list = [Hotels.image_id]
